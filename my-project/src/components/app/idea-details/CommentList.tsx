        ...
        <div className="flex-1">
          <div className="bg-slate-100 rounded-lg p-4">
            ...
            <p className="text-slate-700">
              ...
              confirm that contamination is a huge issue. Have you considered
              how to handle different types of plastics that look similar?
            </p>
          </div>
            ...
            <div className="flex-1">
              <div className="bg-blue-50 rounded-lg p-4">
                ...
                <p className="text-slate-700">
                  ...
                  distinguish between similar-looking plastics based on their
                  chemical signatures.
                </p>
              </div>
              <div className="flex items-center space-x-4 mt-2 ml-4">
      ...
      <div className="flex space-x-4">
        ...
        <div className="flex-1">
          <div className="bg-slate-100 rounded-lg p-4">
            ...
            <p className="text-slate-700">
              I'm a hardware engineer with experience in IoT devices. Would love
              to collaborate on the sensor and mechanical sorting mechanism
              design!
            </p>
          </div>
          <div className="flex items-center space-x-4 mt-2 ml-4">
